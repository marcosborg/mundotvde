        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.admin-statement-responsibilities.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('contract_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="contract_number" id="contract_number" value="{{ old('contract_number', '') }}" step="1" required>
