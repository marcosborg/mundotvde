                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.bots.update", [$bot->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $bot->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('instructions') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="instructions" id="instructions" required>{{ old('instructions', $bot->instructions) }}</textarea>
