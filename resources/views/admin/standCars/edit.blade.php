                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.stand-cars.update", [$standCar->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('year') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="year" id="year" value="{{ old('year', $standCar->year) }}" step="1" required>
                            @if($errors->has('year'))
                        ...
                        <div class="form-group {{ $errors->has('month') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="month_id" id="month_id" required>
                                @foreach($months as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('month_id') ? old('month_id') : $standCar->month->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('month'))
