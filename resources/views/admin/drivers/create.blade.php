                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drivers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('driver_license_expiration_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="driver_license_expiration_date" id="driver_license_expiration_date" value="{{ old('driver_license_expiration_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('vehicle_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="vehicle_date" id="vehicle_date" value="{{ old('vehicle_date', '') }}">
