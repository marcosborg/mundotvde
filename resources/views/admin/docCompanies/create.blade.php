        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.docCompany.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.doc-companies.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('nipc') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nipc" id="nipc" value="{{ old('nipc', '') }}">
                            @if($errors->has('nipc'))
                        ...
                        <div class="form-group {{ $errors->has('license_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="license_number" id="license_number" value="{{ old('license_number', '') }}">
