        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.activityLaunch.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.activity-launches.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('rent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="rent" id="rent" value="{{ old('rent', '0') }}" step="0.01" required>
                            @if($errors->has('rent'))
                        ...
                        <div class="form-group {{ $errors->has('management') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="management" id="management" value="{{ old('management', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('insurance') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="insurance" id="insurance" value="{{ old('insurance', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('fuel') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="fuel" id="fuel" value="{{ old('fuel', '0') }}" step="0.01" required>
                            @if($errors->has('fuel'))
                        ...
                        <div class="form-group {{ $errors->has('tolls') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tolls" id="tolls" value="{{ old('tolls', '0') }}" step="0.01" required>
                            @if($errors->has('tolls'))
                        ...
                        <div class="form-group {{ $errors->has('refund') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="refund" id="refund" value="{{ old('refund', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('final_kilometers') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="final_kilometers" id="final_kilometers" value="{{ old('final_kilometers', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('send') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="send" id="send" value="1" {{ old('send', 0) == 1 ? 'checked' : '' }}>
