        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.activityPerOperator.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.activity-per-operators.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('net') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="net" id="net" value="{{ old('net', '0') }}" step="0.01">
                            @if($errors->has('net'))
                        ...
                        <div class="form-group {{ $errors->has('taxes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="taxes" id="taxes" value="{{ old('taxes', '0') }}" step="0.01">
                            @if($errors->has('taxes'))
