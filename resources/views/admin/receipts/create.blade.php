                    ...
                    <form method="POST" action="{{ route("admin.receipts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('company') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Receipt::COMPANY_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="company_{{ $key }}" name="company" value="{{ $key }}" {{ old('company', 'OC') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('iva') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Receipt::IVA_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="iva_{{ $key }}" name="iva" value="{{ $key }}" {{ old('iva', 'Sem IVA') === (string) $key ? 'checked' : '' }} required>
