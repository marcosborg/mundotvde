        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.crmFormField.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.crm-form-fields.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\CrmFormField::TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', 'text') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('help_text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="help_text" id="help_text" value="{{ old('help_text', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('placeholder') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="placeholder" id="placeholder" value="{{ old('placeholder', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('default_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="default_value" id="default_value" value="{{ old('default_value', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('is_unique') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_unique" id="is_unique" value="1" {{ old('is_unique', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('min_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min_value" id="min_value" value="{{ old('min_value', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('max_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="max_value" id="max_value" value="{{ old('max_value', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('options_json') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="options_json" id="options_json">{{ old('options_json') }}</textarea>
