        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.documentWarning.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.document-warnings.update", [$documentWarning->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('citizen_card') ? 'has-error' : '' }}">
                            <div>
                                <input type="hidden" name="citizen_card" value="0">
                                <input type="checkbox" name="citizen_card" id="citizen_card" value="1" {{ $documentWarning->citizen_card || old('citizen_card', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('tvde_driver_certificate') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="tvde_driver_certificate" id="tvde_driver_certificate" value="1" {{ $documentWarning->tvde_driver_certificate || old('tvde_driver_certificate', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('criminal_record') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="criminal_record" id="criminal_record" value="1" {{ $documentWarning->criminal_record || old('criminal_record', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('profile_picture') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="profile_picture" id="profile_picture" value="1" {{ $documentWarning->profile_picture || old('profile_picture', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('driving_license') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="driving_license" id="driving_license" value="1" {{ $documentWarning->driving_license || old('driving_license', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('iban') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="iban" id="iban" value="1" {{ $documentWarning->iban || old('iban', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('dua_vehicle') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="dua_vehicle" id="dua_vehicle" value="1" {{ $documentWarning->dua_vehicle || old('dua_vehicle', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('car_insurance') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="car_insurance" id="car_insurance" value="1" {{ $documentWarning->car_insurance || old('car_insurance', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('ipo_vehicle') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="ipo_vehicle" id="ipo_vehicle" value="1" {{ $documentWarning->ipo_vehicle || old('ipo_vehicle', 0) === 1 ? 'checked' : '' }}>
