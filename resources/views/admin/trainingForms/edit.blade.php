                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.training-forms.update", [$trainingForm->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $trainingForm->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $trainingForm->phone) }}" required>
                            @if($errors->has('phone'))
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $trainingForm->email) }}">
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('city') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $trainingForm->city) }}">
                            @if($errors->has('city'))
                        ...
                        <div class="form-group {{ $errors->has('rgpd') ? 'has-error' : '' }}">
                            <div>
                                <input type="checkbox" name="rgpd" id="rgpd" value="1" {{ $trainingForm->rgpd || old('rgpd', 0) === 1 ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('obs') ? 'has-error' : '' }}">
                            <label for="obs">{{ trans('cruds.trainingForm.fields.obs') }}</label>
                            <textarea class="form-control" name="obs" id="obs">{{ old('obs', $trainingForm->obs) }}</textarea>
                            @if($errors->has('obs'))
