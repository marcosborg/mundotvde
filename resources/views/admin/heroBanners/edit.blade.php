        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.heroBanner.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.hero-banners.update", [$heroBanner->id]) }}"
                        ...
                        <div class="form-group {{ $errors->has('button') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="button" id="button"
                                value="{{ old('button', $heroBanner->button) }}">
