        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.crmForm.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.crm-forms.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\CrmForm::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', 'draft') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('confirmation_message') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="confirmation_message" id="confirmation_message" value="{{ old('confirmation_message', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('redirect_url') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="redirect_url" id="redirect_url" value="{{ old('redirect_url', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('notify_emails') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="notify_emails" id="notify_emails" value="{{ old('notify_emails', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('create_card_on_submit') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="create_card_on_submit" id="create_card_on_submit" value="1" {{ old('create_card_on_submit', 0) == 1 || old('create_card_on_submit') === null ? 'checked' : '' }}>
