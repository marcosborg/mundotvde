<aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa-fw fas fa-dumbbell">

                    </i>
                    <span>{{ trans('cruds.aiTraining.title') }}</span>
                    <span class="pull-right-container"><i class="fa fa-fw fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    @can('bot_access')
                        <li class="{{ request()->is("admin/bots") || request()->is("admin/bots/*") ? "active" : "" }}">
                            <a href="{{ route("admin.bots.index") }}">
                                <i class="fa-fw fas fa-robot">

                                </i>
                                <span>{{ trans('cruds.bot.title') }}</span>

                            </a>
                        </li>
                    @endcan
                    @can('whatsapp_message_access')
                        <li class="{{ request()->is("admin/whatsapp-messages") || request()->is("admin/whatsapp-messages/*") ? "active" : "" }}">
                            <a href="{{ route("admin.whatsapp-messages.index") }}">
                                <i class="fa-fw fas fa-comments">

                                </i>
                                <span>{{ trans('cruds.whatsappMessage.title') }}</span>

                            </a>
                        </li>
                    @endcan
                    @can('website_message_access')
                        <li class="{{ request()->is("admin/website-messages") || request()->is("admin/website-messages/*") ? "active" : "" }}">
                            <a href="{{ route("admin.website-messages.index") }}">
                                <i class="fa-fw fas fa-comments">

                                </i>
                                <span>{{ trans('cruds.websiteMessage.title') }}</span>

                            </a>
                        </li>
                    @endcan
                    @can('app_message_access')
                        <li class="{{ request()->is("admin/app-messages") || request()->is("admin/app-messages/*") ? "active" : "" }}">
                            <a href="{{ route("admin.app-messages.index") }}">
                                <i class="fa-fw fas fa-comments">

                                </i>
                                <span>{{ trans('cruds.appMessage.title') }}</span>
